      ...
      <div className="pointer-events-none absolute inset-0 flex items-center">
        <div className="container mx-auto px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24">
          ...
          <div className="pointer-events-auto mt-5 sm:mt-6">
            <Link href={routes[selectedIndex].link} className="inline-flex items-center bg-white/90 text-gray-900 hover:bg-white rounded-full px-5 sm:px-6 md:px-7 py-2.5 sm:py-3 md:py-3.5 font-semibold transition">
              Explore route
